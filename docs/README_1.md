...
|-------|--------------|-------------|
| 1     | Custom       | Custom map |
| 2     | WAREHOUSE    | Warehouse scene |
| 3     | TOWN10       | Town scene |
| 4     | YARD         | Courtyard scene |
| 5     | CROWD        | Crowd scene with 50 randomly walking pedestrians and obstacles |
| 6     | VENICE       | Venice-style town with rivers, bridges, and corridors |
| 7     | HOUSE        | Three-bedroom apartment scene |
| 8     | RUNNINGGAME  | Coin collection game |
| 9     | ZOMBIEGAME   | Zombie game |
| 10    | IROSFLAT2024 | IROS competition map 1 |
| 11    | IROSSLOP2024 | IROS competition map 2 |
